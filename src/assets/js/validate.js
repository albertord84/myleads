...
(function() {
	...
	}, jQuery.validator.format("Por favor, digite {0} palavras ou menos."));
...
}, "Por favor, apenas letras, números e sublinhados.");
...
}, "Por favor insira um horário válido, 0:00-23:59");
...
jQuery.validator.addMethod("accept", function(value, element, param) {
	...
	return true;
}, jQuery.format("Por favor insira um tipo de arquivo válido."));
...
$.validator.addMethod("username",function(value,element){
	return this.optional(element) || /^[a-z0-9]{4,21}$/i.test(value); 
},"Nome de Usuário deve ter de 4-20 characters");
...
(function($) {
	...
	$.validator.addMethod("anomodelo", function(value, element) {
		if (value == ""){
			return true;
		}
		...
		if ( $('#ano_de').val() >  $('#ano_ate').val() ){
			return false;
		}else if ( $('#ano_de').val() <=  $('#ano_ate').val() ){
			return true;
		}
		
	},"A data DE deve ser menor ou igual a data ATÉ.");
