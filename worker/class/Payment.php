...
namespace leads\cls {
    ...
    require_once $GLOBALS['sistem_config']->BASE_PATH_URL . '/leads/worker/externals/mundipagg/init.php';
...
//                        ->setOrderReference('NumeroDoPedido');
        ...
        public function create_boleto_payment($payment_data) {
            try {
                ...
                require_once $GLOBALS['sistem_config']->BASE_PATH_URL . '/leads/worker/externals/MundiAPI-PHP/vendor/autoload.php';
                // Define a url utilizada
